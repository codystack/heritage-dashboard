                            ...
                            <div class="card-body pb-0">
                                <form class="row mb-5 mt-5">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input class="form-control" placeholder="1st Activity" type="text">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="col-sm-4 mb-3">
                                        ...
                                        <input class="form-control" placeholder="2nd Activity" type="text">
                                    </div>
                                    <div class="col-sm-4 mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" placeholder="Address" row="5" type="text"></textarea>
                                    </div>
                                    ...
                                    <div class="mt-5 mb-10">
                                        <button type="submit" class="btn w-100 btn-lg btn-dark">Add New Branch</button>
                                    </div>
                                </form>
                            </div>
                        </div>
