                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex align-items-center gap-3 ps-1">
                                                                ...
                                                                <div><span class="d-block text-heading fw-bold">Reality Check</span></div>
                                                            </div>
                                                        </td>
                                                        <td>Luke 3:10 ERV</td>
                                                        <td>The People asked John, “What should we do?"</td>
                                                        <td>21 / 1 / 2024</td>
                                                        <td class="text-end">
                                                            <div class="dropdown">
                                                            <button type="button" class="btn btn-sm btn-square btn-neutral w-rem-6 h-rem-6" data-bs-toggle="dropdown" aria-haspopup="false" aria-expanded="false"><i class="bi bi-three-dots"></i></button>
                                                                <ul class="dropdown-menu dropdown-menu-xs">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit-devotional"><i class="bi bi-pencil-square me-2"></i>Edit</a></li>
