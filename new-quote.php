                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="d-flex align-items-center gap-4">
                                    ...
                                    <h1 class="h4 ls-tight">Add New Quote</h1>
                                </div>
                            </div>
                            ...
                            <div class="card-body pb-0">
                                <form class="row mb-5 mt-5">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" placeholder="Photo Link" type="text">
                                    </div>
                                    <div class="mt-5 mb-10">
                                        <button type="submit" class="btn w-100 btn-lg btn-dark">Add New Quote</button>
                                    </div>
                                </form>
                            </div>
                        </div>
